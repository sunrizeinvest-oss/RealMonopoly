...
export default function FlipCalc() {
  ...
  function generateOfferLetter() {
    ...
    doc.text("rizeai.co", margin, y + 16);
    ...
    doc.text("Generated by rizeai.co  ·  This document is for offer purposes only and does not constitute legal advice.", W / 2, pageH - 20, { align: "center" });
  ...
  function generateLenderPackage() {
    ...
    const drawFooter = (pageLabel) => {
      ...
      doc.text(
        `Prepared by ${company}  ·  rizeai.co  ·  CONFIDENTIAL  ·  ${pageLabel}`,
